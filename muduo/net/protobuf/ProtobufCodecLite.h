...
public:
  ...
  typedef std::function<bool(const TcpConnectionPtr &, StringPiece, Timestamp)>
      RawMessageCallback;
  ...
  ProtobufCodecLite(const ::google::protobuf::Message *prototype,
      ...
      : prototype_(prototype), tag_(tagArg.as_string()),
        messageCallback_(messageCb), rawCb_(rawCb), errorCallback_(errorCb),
  ...
  virtual bool parseFromBuffer(StringPiece buf,
  ...
  ErrorCode parse(const char *buf, int len,
                  ::google::protobuf::Message *message);
  void fillEmptyBuffer(muduo::net::Buffer *buf,
                       const google::protobuf::Message &message);
