...
string SystemInspector::loadavg(HttpRequest::Method,
...
string SystemInspector::version(HttpRequest::Method,
                                const Inspector::ArgList &) {
  string version;
...
string SystemInspector::cpuinfo(HttpRequest::Method,
                                const Inspector::ArgList &) {
  string cpuinfo;
...
string SystemInspector::meminfo(HttpRequest::Method,
                                const Inspector::ArgList &) {
  string meminfo;
...
string SystemInspector::overview(HttpRequest::Method,
                                 const Inspector::ArgList &) {
  string result;
  result.reserve(1024);
