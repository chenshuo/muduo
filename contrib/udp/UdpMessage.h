...
#ifndef MUDUO_CONTRIB_UDPMESSAGE_H
#define MUDUO_CONTRIB_UDPMESSAGE_H
...
{
 public:
  UdpMessage(int fd, const struct sockaddr_in& addr,
        size_t defaultBufferSize = 1472);
  UdpMessage(int fd, size_t defaultBufferSize = 1472);
  UdpMessage(int fd, boost::shared_ptr<muduo::net::Buffer>& buf);
  ...
  boost::shared_ptr<muduo::net::Buffer>& buffer()
  { return buffer_; }
 ...
 private:
  int sockfd_;
  boost::shared_ptr<muduo::net::Buffer> buffer_;
